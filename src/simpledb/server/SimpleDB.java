...
public class SimpleDB {
	...
	public static String CS4431_LFU_LOG = "cs4432_lfu.log";
	public static String CS4431_MRU_LOG = "cs4432_mru.log";
	public static String CS4431_FIFO_LOG = "cs4432_fifo.log";
	...
	public static void initFileLogAndBufferMgr(String dirname, int bufferSelect) {
		...
		switch (bufferSelect) {
			...
			case 2:
			    ...
			    break;
            case 3:
                log_name = CS4431_LFU_LOG;
                break;
            case 4:
                log_name = CS4431_MRU_LOG;
                break;
            case 5:
                log_name = CS4431_FIFO_LOG;
                break;
			default:
			break;
		}
